...
class person:
    ...
    def __init__(self, name, address, corp, telephone):
        ...
        self.corp = corp
        self.contactsFile = 'E:\\Work\\JavaExercise\\Innovation\\src\\main\\resources\\contacts\\contacts.txt'
    ...
    def writeFile(self, personList):
        if not os.path.isfile(self.contactsFile):
            f = file(self.contactsFile, 'a')
        else:
            f = file(self.contactsFile, 'a')
        try:
